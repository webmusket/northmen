...
class Virtualproduct extends Resource
{
     ...
     * @var string
     */
    public static $model = 'App\Virtualproduct';
    ...
    public function fields(Request $request)
    {
        return [
            ...
            new Panel('Product Builder',$this->productbuilderFields()),
    ...
    protected function priceFields(){
        return[
            Number::make('Regular Price','regular_price')->hideFromIndex(),
            Number::make('Sale Price','sale_price')->hideFromIndex(),
            Number::make('Purchase Price','purchase_price')->hideFromIndex(),
        ];
    }
    ...
    protected function productbuilderFields(){
        return[
